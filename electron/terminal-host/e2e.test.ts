 ...
 *
 * The warm-restore handshake is three separate round trips (snapshot, resize,
 * subscribe) and the PTY keeps producing output across all of them, so every
 ...
 */
describe("E2E: warm restore delivers output exactly once", () => {
  let tmpDir: string;
  let daemon: E2EDaemon;
